...
class TestColumnGenerators(defaultSetup):
    ...
    def test_generators(self):
        self.assertEqual([i for i in self.builder.col_1s], self.col1_nums)
        self.assertEqual([i for i in self.builder.col_2s], self.col2_nums)
        self.assertEqual([i for i in self.builder.col_3s], self.col3_nums)
